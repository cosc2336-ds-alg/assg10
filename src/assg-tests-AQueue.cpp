 ...
 */
/*
   TEST_CASE("AQueue test front() member method basic functionality",
          "[task1]")
   {
 ...
 */
/*
   TEST_CASE("AQueue test dequeue() member method basic functionality",
          "[task2]")
   {
 ...
 */
/*
   TEST_CASE("AQueue test enqueue() member method basic functionality",
          "[task3]")
   {
   SECTION("test dequeue on a queue of integer values")
   {
 ...
 */
/*
   TEST_CASE("AQueue<int> test integer queue concrete array implementation",
          "[task3]")
   {
 ...
 */
/*
   TEST_CASE("AQueue<string> test string queue concrete array implementation",
          "[task3]")
   {
   SECTION("test empty queue is empty")
   {
